...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpendapCatalog.service_prefix'
        db.add_column('dpnetcdf_opendapcatalog', 'service_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpendapCatalog.service_prefix'
        db.delete_column('dpnetcdf_opendapcatalog', 'service_prefix')
