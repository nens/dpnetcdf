...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpendapDataset.year_str'
        db.add_column('dpnetcdf_opendapdataset', 'year_str',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpendapDataset.year_str'
        db.delete_column('dpnetcdf_opendapdataset', 'year_str')
    ...
    models = {
        ...
        'dpnetcdf.opendapdataset': {
            ...
            'year_str': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
