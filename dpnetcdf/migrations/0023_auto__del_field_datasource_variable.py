...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dpnetcdf_datasource', 'variable')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Datasource.variable'
        raise RuntimeError("Cannot reverse this migration. 'Datasource.variable' and its values cannot be restored.")
    ...
    models = {
        'dpnetcdf.datasource': {
            ...
            'var': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dpnetcdf.Variable']", 'null': 'True'}),
