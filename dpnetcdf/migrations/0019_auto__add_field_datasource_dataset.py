...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dpnetcdf_datasource', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnetcdf.OpendapDataset'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datasource.dataset'
        db.delete_column('dpnetcdf_datasource', 'dataset_id')
