...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field datasources on 'MapLayer'
        db.create_table('dpnetcdf_maplayer_datasources', (
        ...
        db.create_unique('dpnetcdf_maplayer_datasources', ['maplayer_id', 'datasource_id'])


    def backwards(self, orm):
        # Removing M2M table for field datasources on 'MapLayer'
        db.delete_table('dpnetcdf_maplayer_datasources')
