...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapLayer.connection_shape_file'
        db.add_column('dpnetcdf_maplayer', 'connection_shape_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'maplayers', null=True, to=orm['dpnetcdf.ShapeFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapLayer.connection_shape_file'
        db.delete_column('dpnetcdf_maplayer', 'connection_shape_file_id')
    ...
    models = {
        ...
        'dpnetcdf.maplayer': {
            ...
            'connection_shape_file': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'maplayers'", 'null': 'True', 'to': "orm['dpnetcdf.ShapeFile']"}),
