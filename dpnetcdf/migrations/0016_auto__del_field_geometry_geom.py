...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Geometry.geom'
        db.delete_column('dpnetcdf_geometry', 'geom')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Geometry.geom'
        raise RuntimeError("Cannot reverse this migration. 'Geometry.geom' and its values cannot be restored.")
