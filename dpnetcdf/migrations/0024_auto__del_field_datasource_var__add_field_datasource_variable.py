...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Datasource.var'
        db.delete_column('dpnetcdf_datasource', 'var_id')

        # Adding field 'Datasource.variable'
        db.add_column('dpnetcdf_datasource', 'variable',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnetcdf.Variable'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Datasource.var'
        db.add_column('dpnetcdf_datasource', 'var',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnetcdf.Variable'], null=True),
                      keep_default=False)

        # Deleting field 'Datasource.variable'
        db.delete_column('dpnetcdf_datasource', 'variable_id')
