...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShapeFile.shape_file_path'
        db.add_column('dpnetcdf_shapefile', 'shape_file_path',
                      self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShapeFile.table_generated'
        db.add_column('dpnetcdf_shapefile', 'table_generated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShapeFile.shape_file_path'
        db.delete_column('dpnetcdf_shapefile', 'shape_file_path')

        # Deleting field 'ShapeFile.table_generated'
        db.delete_column('dpnetcdf_shapefile', 'table_generated')
    ...
    models = {
        ...
        'dpnetcdf.shapefile': {
            ...
            'shape_file_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'table': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'table_generated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        'dpnetcdf.style': {
