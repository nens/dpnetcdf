...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OpendapDataset.url'
        db.alter_column('dpnetcdf_opendapdataset', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'OpendapDataset.url'
        db.alter_column('dpnetcdf_opendapdataset', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))
