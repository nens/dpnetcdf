...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geometry.geometry'
        db.add_column('dpnetcdf_geometry', 'geometry',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Geometry.geometry'
        db.delete_column('dpnetcdf_geometry', 'geometry')
