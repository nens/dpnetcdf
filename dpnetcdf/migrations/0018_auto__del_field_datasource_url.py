...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dpnetcdf_datasource', 'url')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Datasource.url'
        raise RuntimeError("Cannot reverse this migration. 'Datasource.url' and its values cannot be restored.")
