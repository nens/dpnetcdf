...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Datasource.imported'
        db.alter_column('dpnetcdf_datasource', 'imported', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Datasource.imported'
        raise RuntimeError("Cannot reverse this migration. 'Datasource.imported' and its values cannot be restored.")
