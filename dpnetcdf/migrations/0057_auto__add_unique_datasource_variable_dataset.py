...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Datasource', fields ['variable', 'dataset']
        db.create_unique('dpnetcdf_datasource', ['variable_id', 'dataset_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Datasource', fields ['variable', 'dataset']
        db.delete_unique('dpnetcdf_datasource', ['variable_id', 'dataset_id'])


    models = {
        'dpnetcdf.datasource': {
            'Meta': {'ordering': "(u'dataset__name',)", 'unique_together': "((u'dataset', u'variable'),)", 'object_name': 'Datasource'},
