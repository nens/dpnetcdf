...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapLayer.sql_query'
        db.add_column('dpnetcdf_maplayer', 'sql_query',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapLayer.sql_query'
        db.delete_column('dpnetcdf_maplayer', 'sql_query')
    ...
    models = {
        'dpnetcdf.datasource': {
            ...
            'geometries': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['dpnetcdf.Geometry']", 'symmetrical': 'False', 'blank': 'True'}),
