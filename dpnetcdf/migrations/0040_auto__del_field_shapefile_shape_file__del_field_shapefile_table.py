...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShapeFile.shape_file'
        db.delete_column('dpnetcdf_shapefile', 'shape_file')

        # Deleting field 'ShapeFile.table'
        db.delete_column('dpnetcdf_shapefile', 'table')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ShapeFile.shape_file'
        raise RuntimeError("Cannot reverse this migration. 'ShapeFile.shape_file' and its values cannot be restored.")
        # Adding field 'ShapeFile.table'
        db.add_column('dpnetcdf_shapefile', 'table',
