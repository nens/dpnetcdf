...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShapeFile.identifier'
        db.add_column('dpnetcdf_shapefile', 'identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShapeFile.identifier'
        db.delete_column('dpnetcdf_shapefile', 'identifier')
