...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datasource.shape_file'
        db.add_column('dpnetcdf_datasource', 'shape_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dpnetcdf.ShapeFile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datasource.shape_file'
        db.delete_column('dpnetcdf_datasource', 'shape_file_id')
